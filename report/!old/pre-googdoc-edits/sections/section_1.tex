...
Despite women’s modest advantage in formal schooling, men earn substantially higher wages at period~0. The mean log hourly wage is $1.866$ for men compared to $1.658$ for women, corresponding to a large and statistically significant gender gap (the $t$--statistic is about $-20.8$). Coworker wages show a similar pattern: men are more likely to work alongside higher-paid coworkers (mean $owage2$ of $1.725$ for men compared to $1.638$ for women), suggesting systematic gender differences in the types of jobs or firms where workers are employed.
